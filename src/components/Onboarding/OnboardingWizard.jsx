...
const ONBOARDING_COPY = {
  en: {
    ...
    verifying: 'Verifying...',
    accessManage: 'After sign-in, you can manage credits, devices, and BYOK in Settings.',
    skip: 'Skip for now',
    back: 'Back',
    next: 'Next',
    getStarted: 'Get started',
  ...
  ru: {
    ...
    verifying: 'Проверяю...',
    accessManage: 'После входа вы сможете управлять кредитами, устройствами и BYOK в Settings.',
  ...
  bg: {
    ...
    verifying: 'Проверявам...',
    accessManage: 'След вход можеш да управляваш кредитите, устройствата и BYOK от Settings.',
    skip: 'Пропусни засега',
    back: 'Назад',
    next: 'Напред',
    getStarted: 'Започни',
  ...
  es: {
    ...
    verifying: 'Verificando...',
    accessManage: 'Después de iniciar sesión, podrás gestionar créditos, dispositivos y BYOK en Settings.',
    skip: 'Omitir por ahora',
    back: 'Atrás',
    next: 'Siguiente',
    getStarted: 'Empezar',
  ...
  fr: {
    ...
    verifying: 'Vérification...',
    accessManage: 'Après connexion, vous pourrez gérer les crédits, les appareils et le BYOK dans Settings.',
    skip: 'Passer pour le moment',
    back: 'Retour',
    next: 'Suivant',
    getStarted: 'Commencer',
  ...
  it: {
    ...
    verifying: 'Verifica in corso...',
    accessManage: 'Dopo l’accesso potrai gestire crediti, dispositivi e BYOK in Settings.',
    skip: 'Salta per ora',
    back: 'Indietro',
    next: 'Avanti',
    getStarted: 'Inizia',
  ...
  pt: {
    ...
    verifying: 'A verificar...',
    accessManage: 'Depois de iniciar sessão, poderá gerir créditos, dispositivos e BYOK em Settings.',
    skip: 'Saltar por agora',
    back: 'Voltar',
    next: 'Seguinte',
    getStarted: 'Começar',
  ...
  pl: {
    ...
    verifying: 'Weryfikuję...',
    accessManage: 'Po zalogowaniu możesz zarządzać kredytami, urządzeniami i BYOK w Settings.',
    skip: 'Pomiń na razie',
    back: 'Wstecz',
    next: 'Dalej',
    getStarted: 'Zacznij',
  ...
  de: {
    ...
    verifying: 'Wird geprüft...',
    accessManage: 'Nach der Anmeldung können Sie Credits, Geräte und BYOK in Settings verwalten.',
    skip: 'Vorerst überspringen',
    back: 'Zurück',
    next: 'Weiter',
    getStarted: 'Loslegen',
