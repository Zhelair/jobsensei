...
const TRANSLATIONS = {
  en: {
    ...
    'applications.add.copy': 'Add the company, role, and JD first. That required context keeps interview prep, gap analysis, and follow-up aligned to the same application.',
    ...
    'applications.add.recommended': 'Required',
    'applications.add.saved': 'Saved',
    'applications.add.addNowOrLater': 'Required',
    ...
    'applications.add.createAddJdLater': 'Create workspace',
    'applications.add.openImmediately': 'You can open the full workspace immediately.',
    'applications.add.addJdLaterHelp': 'You can still create the workspace now, but add the JD inside it before using the main prep flow.',
    'applications.add.jdHelp': 'Required for role-specific prep. Add the JD here or paste it from the Capture step inside the workspace before using the main interview-prep tools.',
    ...
    'today.startFirst': 'JobSensei turns one job description into a complete interview-prep workflow.',
    'today.startCopy': 'Add the company, role, and job description once, then see your likely gaps, practice the interview, and keep your notes, follow-up, and prep in one place.',
    ...
    'today.firstStepTitle': 'Add application to create the workspace',
    ...
    'today.prepHubsNote': 'These 6 steps are the initial workflow. Older checks and extra prep tools stay available later if you want to go deeper.',
    ...
    'today.steps.tailor.done': 'Gap analysis and at least one follow-up prep check are already saved for this role.',
    'today.steps.tailor.todo': 'Use gap analysis and STAR stories to make your answers sound role-specific.',
    'today.steps.tailor.todoAfterGap': 'Gap analysis is saved. Run one more prep check like Resume Checker before moving to question prediction.',
    ...
    'today.recentPrepTitle': 'Recent Prep Activity',
    'today.recentPrepCopyActive': 'Showing the latest 5 prep runs for this application. Older checks stay saved inside Interview Prep and Prep Tools.',
    'today.recentPrepCopyProject': 'Showing the latest 5 prep runs across this project. Older checks stay saved inside Interview Prep and Prep Tools.',
    ...
    'voice.micUnsupported': 'Voice input is not available on this browser/device',
    'voice.micUnsupportedNote': 'This device does not expose browser speech recognition yet. Text chat and spoken playback can still work.',
    'applications.confirmDelete': 'Remove {application} from Applications? This will delete its saved workspace data from this project.',
    'applications.workspace.overview.initialFlowNote': 'These {count} steps are the initial workflow. You can still open more prep tools later if you want deeper checks.',
    'applications.workspace.steps.tailor.descAfterGap': 'Gap analysis is saved. Add one follow-up prep check before you move on to question prediction.',
    'applications.workspace.steps.tailor.summaryAfterGap': 'Gap analysis is saved. Next recommended check: Resume Checker.',
  },
  ru: {
    'nav.today': 'Сегодня',
